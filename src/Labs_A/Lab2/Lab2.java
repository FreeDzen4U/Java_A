...
public class Lab2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(colorTextBlue + "\nСума максимальних чисел з парними номерами = " + colorTextYellow + summa);
        ...
        System.out.println(colorTextBlue + "Сума мінімальних чисел з непарними номерами = " + colorTextYellow + summa);
    }
}